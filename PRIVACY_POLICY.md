## RxConverter: Privacy policy

Welcome to the RxConverter app for Android!

This is an open source Android app developed by Christian Nguyen. The source code is available on GitHub under the MIT License.
